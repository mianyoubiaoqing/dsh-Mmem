...
.dsh-mmem-settings form{display:grid;grid-template-columns:minmax(180px,1fr) repeat(3,minmax(120px,auto)) auto;gap:8px;align-items:center}.dsh-mmem-settings form strong{grid-column:1/-1;font-size:14px}.dsh-mmem-settings input,.dsh-mmem-settings select,.dsh-mmem-settings textarea{min-width:0;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);font:inherit;border-radius:7px;padding:7px 9px}.dsh-mmem-settings textarea{grid-column:1/-1;min-height:90px;resize:vertical}
