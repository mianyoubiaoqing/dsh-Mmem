...
function assertPackedFiles(files) {
  ...
  for (const required of [
    ...
    'lib/memory/approval-review.js',
    'lib/memory/approval-review-dsh.js',
    'lib/memory/turn-summary-policy.js',
    'lib/memory/turn-summary-dsh.js',
    'lib/memory/standalone-migration.js',
  ...
  execFileSync(
    ...
    [
      ...
      `for (const specifier of [
        ...
        '${expectedName}/approval-review',
        '${expectedName}/approval-review-dsh',
        '${expectedName}/turn-summary-policy',
        '${expectedName}/turn-summary-dsh',
        '${expectedName}/standalone-migration',
